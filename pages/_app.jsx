...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        <title>Linlin的個人網頁</title>
          <link rel="shortcut icon" href="https://avatars.githubusercontent.com/u/158514867?v=4" type="image/x-icon" ></link>
        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/75 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                      <p className="text-6xl mb-5 font-semibold">雪村さや(Yukimura Saya)</p>
